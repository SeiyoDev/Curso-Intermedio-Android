package com.seiyodev.horoscapp.ui.providers

import com.seiyodev.horoscapp.R
import com.seiyodev.horoscapp.ui.model.LuckyModel
...
class RandomCardProvider @Inject constructor() {
    fun getLucky(): LuckyModel?{
        return when(Random.nextInt(0,33)){
            ...
            31 -> LuckyModel(R.drawable.card_queen_cup, R.string.luck_31)
            32 -> LuckyModel(R.drawable.card_lovers, R.string.luck_32)
            else -> null
        }
    }
}